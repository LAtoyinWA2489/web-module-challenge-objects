...
console.log('Task 1a', createMenuItem('sushi', 15, 'Lunch'));
console.log('Task 1a', createMenuItem('cachupa', 8, 'Breakfast'));
console.log('Task 1a', createMenuItem('sandwich', 8, 'Lunch'));
...
console.log('Task 5', addReview(reviews, 'Daniela', 5, 'Beautfilu atmosphere and wonderful vegan options!'));
